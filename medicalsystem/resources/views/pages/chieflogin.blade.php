...
<form action="/doctor/loginchief"  method="post" class="border1-class">
    @csrf
<div class="form-group">
<label for="myId" class="danger"><b><i>Chief ID</i></b></label>
<input class="form-control" id="myId" placeholder="ID" type="text" name="chief_id" required>
</div>
...
@endisset
<div class="form-group text-center"><a style="color:blue" href="/doctor/registerchief"><b><i>SIGN UP</i></b></a></div>
</form>
