...
<form action="/doctor/login"  method="post" class="border1-class">
    @csrf
<div class="form-group">
<label for="myId" class="danger"><b><i>Doctor ID</i></b></label>
<input class="form-control" id="myId" placeholder="ID" type="text" name="doctor_id" required>
</div>
