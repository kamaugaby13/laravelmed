...
<form class="bg-info right" action="/doctor/finddoctor" method="post">
    @csrf
...
<tr class="lead">
    ...
    <td><a href="/doctor/removedoctor?doctor_id={{$doctor->doctor_id}}">REMOVE</a></td>
    </tr>
@empty
<tr class="lead text-danger">
    <td>No doctors in the system!</td>
    </tr>
@endforelse
