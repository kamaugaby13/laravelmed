...
@endsection
@section('content')
<form action="/doctor/dietregister"  method="post" class="border1-class">
    @csrf
    ...
    <div class="form-group">
    <label for="myPass" class="danger"><b><i>Dietician ID</i></b></label>
    <input class="form-control" id="myPass" placeholder="ID" type="text" name="dietician_id"
